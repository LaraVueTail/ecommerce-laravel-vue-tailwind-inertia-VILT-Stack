<template>
    <div
        ...
        <form action="#" @submit.prevent="">
                                ...
                                <div class="grid sm:grid-cols-12 gap-8">
                                    <div class="col-span-5">
                                        <label for="page_name"
                                            ...
                                            Name</label>
                                        <input type="text" name="page_name" id="page_name" v-model="link.pageName"
                                    ...
                                    <div class="col-span-6">
                                        <label for="page_link"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Page
                                            Link</label>
                                        <input type="text" name="page_link" id="page_link" v-model="link.pageLink"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="" />
                                    </div>
                                ...
                                <div class="grid sm:grid-cols-12 gap-8">
                                    <div class="col-span-5">
                                        <label for="page_name"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Page
                                            Name</label>
                                        <input type="text" name="page_name" id="page_name" v-model="linkName"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="" />
                                    </div>
                                    <div class="col-span-6">
                                        <label for="page_link"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Page
                                            Link</label>
                                        <input type="text" name="page_link" id="page_link" v-model="linkLink"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="" />
                                    </div>
                                    ...
                                    <div class="self-end place-self-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                            class="w-10 h-10 text-blue-700" @click="addPageLink">
                            ...
                            <div class="p-2" v-for="link,index in socialLinks" :key="index">
                                <div class="grid sm:grid-cols-12 gap-8">
                                    <div class="self-center place-self-center">
                                        <i :class="`fa-brands fa-${link.socialName} text-2xl text-gray-800`"></i>
                                    </div>
                                    <div class="col-span-11">
                                        <input type="text" name="page_link" id="page_link" v-model="link.socialLink"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="" />
                                    </div>
            ...
            <div>
                <Errors :errors="footerContentsErrors ?? false"></Errors>
                <div class="flex items-center space-x-4">
                    <Button @click.prevent="updateFooter()" :text="'Update Footer'" :color="'blue'"></Button>
                </div>
            </div>
        </form>
    </div>
...
export default {
    props: ["footerContentErrors", "footerContent"],
    data() {
        return {
            footerContentInfo: this.footerContent,
            pageLinks: JSON.parse(this.footerContent.page_links),
            socialLinks: JSON.parse(this.footerContent.social_links),
            errors: this.footerContentErrors ?? {},
            linkName: '',
            linkLink: '',
        };
    },
    methods: {
        ...
        updateFooter() {
            ...
            router.post(`/admin-dashboard/footer-content/1`, this.footerContentInfo, {
                preserveState: true,
                preserveScroll: true,
