    ...
    watch: {
        search:
            debounce(function (newValue) {
                ...
                router.get('/admin-dashboard/orders', { search: newValue, filters: this.filters }, { preserveState: true, replace: true });
            }, 300),
        filters(newValue,oldValue){
            router.get('/admin-dashboard/orders', { search: this.search, filters: newValue }, { preserveState: true, replace: true })
