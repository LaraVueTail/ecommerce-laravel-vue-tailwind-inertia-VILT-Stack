                  ...
                  <div>
                    ...
                    <div class="grid gap-4 grid-cols-2 sm:grid-cols-4">
                      ...
                      <FormInput
                        ...
                        :name="'inventory'"
                        :type="'number'"
                        v-model="userInfo.inventory"
                        :error="errors.inventory"
                      ></FormInput>
                      <FormSelect
                        :label="'Availability'"
                        :name="'availability'"
                        v-model="userInfo.availability"
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                      ...
                      <FormInput
                        ...
                        :name="'link'"
                        :type="'text'"
                        :readOnly="`http://127.0.0.1:8000/users/${userInfo.slug}`"
                        :disabled="true"
                        :error="errors.link"
                      ></FormInput>
                    </div>
                ...
                <div class="grid sm:col-span-2">
                  <div>
                    ...
                    <FormFileUploadMultiple
                      @filesChange="(files) => (this.userInfo.more_images = files)"
                      :label="'More Images'"
                      :name="'more_images'"
