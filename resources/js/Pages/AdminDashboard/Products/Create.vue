              ...
              <div class="grid gap-4 mb-4 sm:grid-cols-5">
                  ...
                  <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                      ...
                      <div>
                        ...
                        >
                          <option
                            v-for="tag in ['best_seller', 'new_arrival', 'end_of_season']"
                            :key="tag"
                            :value="tag"
                          >
                            {{ tag }}
                ...
                <div class="grid sm:col-span-2">
                  <div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-2 py-2 justify-items-stretch">
                      <div v-for="(addedImage, index) in addedImages" :key="addedImage">
                        ...
                        <div
                          class="bg-cover bg-center h-24 w-full rounded-lg hover:grayscale cursor-pointer grid place-content-center hover:text-white"
                          :style="`background-image: url(${uploadedImage(index)})`"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            ...
                            stroke-width="2.5"
                            stroke="currentColor"
                            class="w-10 h-10 text-red-500 hover:cursor-pointer"
                            @click="deleteProductAttribute(attribute)"
                          >
                            <path
                              stroke-linecap="round"
                  ...
                  <div class="grid">
                    ...
                    <div class="sm:col-span-2">
                      ...
                      <textarea
                        id="short_description"
                        v-model="productInfo.long_description"
                        rows="5"
                        class="mb-2 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
  ...
  methods: {
    ...
    addProductAttribute() {
      if (this.newAttribute.attribute_label && this.newAttribute.attribute_value)
        this.productAttributes.push(this.newAttribute);
    },
    ...
    imageAdded(files) {
      ...
      //   this.$refs.uploadedImage.src = URL.createObjectURL(file[0]);
      //   console.log(file);
    },
    uploadedImage(index) {
      var src = "";
      if (this.addedImages.length) {
        src = URL.createObjectURL(this.addedImages[index]);
      }
      return src;
    },
