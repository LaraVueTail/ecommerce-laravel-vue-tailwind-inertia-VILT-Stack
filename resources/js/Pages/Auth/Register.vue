<template>
    ...
    <div class="min-h-screen md:bg-gray-800">
        <div class="contain py-10 mb-5 px-4 md:px-64">
            ...
            >
                <h2
                    class="text-xl text-center md:text-2xl uppercase font-medium mb-1"
                >
                    Register Now
                </h2>
                ...
                >
                    <div class="space-y-2">
                        <div>
                            <label for="first_name" class="text-gray-600 mb-2 block"
                                >First name</label
                            >
                            <input
                        ...
                        <div>
                            <label for="last_name" class="text-gray-600 mb-2 block"
                                >Last name</label
                            >
                            <input
                ...
                <p class="mt-4 text-center text-gray-600 text-sm">
                    ...
                    <Link href="login" class="text-primary text-sm"
                        >Login now</Link
                    >
                </p>
            </div>
